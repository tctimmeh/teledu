...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CharacterAttributeDefinition.display'
        db.add_column('teledu_characterattributedefinition', 'display',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CharacterAttributeDefinition.display'
        db.delete_column('teledu_characterattributedefinition', 'display')
