...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ConceptInstance', fields ['concept', 'name']
        db.create_unique('teledu_conceptinstance', ['concept_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'ConceptInstance', fields ['concept', 'name']
        db.delete_unique('teledu_conceptinstance', ['concept_id', 'name'])
