...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('teledu_characterattributedefinition', 'concept_id', 'valueConcept_id')

        # Adding field 'ConceptAttributeDefinition.valueConcept'
        db.add_column('teledu_conceptattributedefinition', 'valueConcept',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teledu.GameSystemConcept'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConceptAttributeDefinition.list'
        db.add_column('teledu_conceptattributedefinition', 'list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        db.rename_column('teledu_characterattributedefinition', 'valueConcept_id', 'concept_id')

        # Deleting field 'ConceptAttributeDefinition.valueConcept'
        db.delete_column('teledu_conceptattributedefinition', 'valueConcept_id')

        # Deleting field 'ConceptAttributeDefinition.list'
        db.delete_column('teledu_conceptattributedefinition', 'list')
    ...
    models = {
        ...
        'teledu.characterattributedefinition': {
            ...
            'valueConcept': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teledu.GameSystemConcept']", 'null': 'True', 'blank': 'True'})
        },
